...
Backtest and analysis live in the sibling repo [Huginn](../huginn) (`python scripts/run_backtest.py`).
...
config/
  nba.js              # NBA model constants: SAMPLE_SIZE, LAMBDA, HOME_BOOST, Z thresholds, VIG rates
```
